...
class CollectionLayout: UICollectionViewLayout {
    ...
    override func prepare() {
        ...
        let itemPerRow: Int = 3
        let normalColumnWidth: CGFloat = contentWidth / CGFloat(itemPerRow)
        ...
        for _ in 0..<2 {
            ...
            offsets.append(featuredColumnWidth + cellPadding)
        ...
        for item in 0..<collectionView.numberOfItems(inSection: 0) {
            ...
            let xPos = offsets[itemInSection]
